...
client = LineClient() 
client._tokenLogin(token="EpZmr1vHTETBgTktOSFd.rLylacrPH39WJb0UIwB8Nq.iF+C5K0kG+xhIuIcc90vb1ER+7aCRdeMt1j/ocjPQSU=")
print 'Success'
reload(sys)
...
wait2 = {    
    'message':"Thanks for add me,My Creator Http://line.me/ti/p/~a_ulul15" 
    }
